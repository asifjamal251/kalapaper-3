                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="overflow-hidden card card-bg-fill galaxy-border-none">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="p-4 p-lg-5 auth-one-bg h-100" style="background-image: url({{asset('images/ar-technology-1.jpeg')}});">
                                        <div class="bg-overlay"></div>
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="{{route('admin.login.form')}}" class="d-block">
                                                    <img alt="{{get_app_setting('title')}}" src="{{asset(get_app_setting('logo')?? 'images/logo.png')}}" alt="" height="60">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" Transforming ideas into intelligent digital solutions through technology, trust, and innovation — that’s the power of AR Technology. "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" At AR Technology, we build secure, intelligent solutions that empower businesses to move faster, think smarter, and lead the future with confidence. "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" AR Technology delivers cutting-edge digital solutions designed to protect your data, enhance productivity, and drive sustainable growth. "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end carousel -->
                                    ...
                                    <div class="p-4 p-lg-5">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="mb-3 form-group {{ $errors->has('username') ? ' has-error' : '' }}">
                                                {{ html()->label('Username or Email', 'username') }}
                                                {{ html()->text('username')
                                                ->class('form-control')
