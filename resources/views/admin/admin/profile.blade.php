...
<div class="position-relative mx-n4 mt-n4">
    <div class="profile-wid-bg profile-setting-img">
        <img src="{{asset(getAdmin('cover')??'admin-assets/images/profile-bg.jpg')}}" class="profile-wid-img" alt="">
                ...
                <div class="tab-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 text-end">
                            {{ html()->button('Save Changes')->type('button')->class('btn btn-primary')->attribute('onclick = store(this)') }}
                        </div>
                    </div>
                    {{ html()->form()->close() }}
                    </div>
                    ...
                    <div class="tab-pane" id="change_password" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-end">
                                {{ html()->button('Update Password')->type('button')->class('btn btn-primary')->attribute('onclick = store(this)') }}
                            </div>
                        </div>
                        {{ html()->form()->close() }}
...
<script type="text/javascript">
    ...
    f{{-- unction changePassword(element){
