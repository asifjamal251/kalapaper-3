    ...
    <div class="layout-width">
        <div class="navbar-header">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ route('admin.dashboard.index') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            ...
                            <img src="{{asset(get_app_setting('logo')??'/images/logo.png')}}" alt="">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset(get_app_setting('logo')??'/images/logo.png')}}" alt="">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <button id="create" data-url="{{ route('admin.stock.create.book') }}" model-size="modal-md" data-title="Booked Stock" type="button" class="btn btn-icon btn-topbar material-shadow-none btn-ghost-secondary rounded-circle open-cart" id="page-header-cart-dropdown">
                        <i class="bx bx-shopping-bag fs-22"></i>
                        <span class="itemCount position-absolute topbar-badge cartitem-count fs-10 translate-middle badge rounded-pill bg-info">  {{ count(session('job_card_item', [])) }}</span>
                    </button>
                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{asset(getAdmin('avatar')??'/images/user.png')}}"
                                alt="{{getAdmin('name')}}">
